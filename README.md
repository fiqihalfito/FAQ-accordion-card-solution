# Frontend Mentor - FAQ accordion card solution using NEXT.JS 13, Tailwind CSS, and Framer Motion
...
- [Framer Motion](https://framer.com/motion) - for transition

### What I learned

Accodion using Framer Motion
